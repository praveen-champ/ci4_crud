...
<?php include(APPPATH . 'Views/header.php'); ?>
  ...
  <form method="post" id="update_user" name="update_user" action="<?= base_url('public/update') ?>">
      ...
      <div class="form-group">
        <label>Salary</label>
        <input type="number" name="salary" class="form-control" value="<?php echo $user_obj['salary']; ?>">
      </div>
